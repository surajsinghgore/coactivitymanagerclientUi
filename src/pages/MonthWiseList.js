...
export default function MonthWiseList() {
...
getStudentAllData();
  ...
  return (
    ...
    <TopBar />
   <h1>This are the records entered by You</h1>
<div className="tt">
...
{demos.length===0? "NO  RCORD FOUND":<><h1>All Records</h1>
<div className="th2">
...
<div className="activityname3">Activity Name</div>
...
<div className="activityname3">{itm.ActivityName}</div>
