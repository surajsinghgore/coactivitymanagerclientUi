...
export default function DownloadPdfActivity() {
...
navigate("/printTemplate");
  ...
  return (
    ...
    <TopBar />
    <h1>Click on Activity Which Wanted to Downloard Pdf</h1>
<div className="tt">
...
return (
<div className="td3" onClick={()=>download(itm,item)} key={itm._id}>
...
<div className="opt3"  style={{cursor:"pointer",marginTop:"1%"}} ><AiOutlineCloudDownload id="icon"/></div>
</div>
)
})}
</div> 
